# tap_azure_cloud_storage/__init__.py
...
from tap_azure_cloud_storage.discover import discover_streams
from tap_azure_cloud_storage.sync import sync_stream, stream_is_selected
from tap_azure_cloud_storage.config import CONFIG_CONTRACT
