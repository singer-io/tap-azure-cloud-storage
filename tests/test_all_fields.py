...
class AzureCloudStorageAllFieldsTest(AzureCloudStorageBaseTest):
    """
    Test that all fields in a CSV file are discovered and synced correctly.
    Tests CSV file with duplicate headers.
    """

    table_entry = [
        {
            'table_name': 'all_fields_csv',
            'search_prefix': 'tap_azure_tester',
            'search_pattern': 'CSV_file_with_duplicate_header.csv',
            'key_properties': ['head1']
        }
    ]
    ...
    def test_run(self):
        """
        Test that verifies all fields discovered are present in synced records.
        """
