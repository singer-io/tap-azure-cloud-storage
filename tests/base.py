...
class AzureCloudStorageBaseTest(unittest.TestCase):
    """
    Base test class for tap-azure-cloud-storage integration tests.
    ...
    def tap_name():
        """The name of the tap"""
        return "tap-azure-cloud-storage"

    @staticmethod
    def get_type():
        """The connection type for tap-tester"""
        return "platform.azure-cloud-storage"
    ...
    def get_properties(self, original: bool = True):
        ...
        Returns:
            dict: Configuration properties including container_name and tables
        """
        props = {
